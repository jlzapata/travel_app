...
import 'package:travel_animated/gradient_status_tag.dart';
import 'package:travel_animated/place.dart';
import 'package:travel_animated/place_images_page_view.dart';
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned.fill(
          ...
          child:
              TranslateAnimation(child: _LikesAndSharesContainer(place: place)),
        ),
        Align(
